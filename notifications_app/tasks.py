...
from celery import shared_task
from core.emails import send_subscription_expired_email

# tasks.py

@shared_task
def send_subscription_expired_email_task(subscriber_email):
    send_subscription_expired_email(subscriber_email)